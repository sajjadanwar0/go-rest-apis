...
// PrintInfo Declare some helper methods for writing log entries at the different levels. Notice
...
// We also implement  Write() method on our Logger type so that it satisfies the
